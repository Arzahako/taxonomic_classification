...
The findings from this research are presented in the paper titled 
Taxonomic Classification of Gene Sequences using Deep Learning, Anna Zakharenko, Yuri Gordienko, and Olga Rusanova, 
International Conference on Information and Software Technologies (ICIST), 16-17 October 2025 (Kaunas, Lithuania)
https://icist.ktu.edu (submitted).
